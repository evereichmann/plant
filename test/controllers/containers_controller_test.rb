...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container" do
    assert_difference('Container.count') do
      post containers_url, params: { container: { plant_name: @container.plant_name, pot_number: @container.pot_number } }
    end
  ...
  test "should update container" do
    patch container_url(@container), params: { container: { plant_name: @container.plant_name, pot_number: @container.pot_number } }
